from ansible_mikrotik_utils import compare
...
def test_compare():
    ...
    print ; remove 5
    print ; remove 5
    print ; add chain=test comment=foo place-before=1
    add chain=test comment=bar
    print ; move 1 4
    print ; move 2 2
    print ; move 1 6
    print ; move 2 4
    """
    actual_changes = list(compare(BASE, TARGET).export())
    expected_changes = list(filter(None, map(str.strip, CHANGES.split('\n'))))
